...
def predict_daily(train_dataset, test_dataset):
    ...
    gbm = lgb.train(lgb_params, lgb_train, num_boost_round=800, valid_sets=lgb_test)
...
daily_dataset = pd.read_csv(DATA_PATH)
...
monthly_feature_columns = ['grid_id', 'lat', 'lon',
                           'TMP_P0_L1_GLL0', 'SPFH_P0_2L108_GLL0', 'RH_P0_L4_GLL0',
                           'PWAT_P0_L200_GLL0', 'UGRD_P0_L6_GLL0', 'GUST_P0_L1_GLL0',
                           'PRES_P0_L7_GLL0', 'CultivatedLand', 'WoodLand', 'GrassLand', 'Waters',
                           'UrbanRural', 'UnusedLand', 'Ocean', 'ELEVATION', 'AOD', 'month',
...
# plt.savefig('lightgbm.png', format='png', transparent=True, dpi=130, pad_inches=0.1, bbox_inches='tight')
