...
for ax, month in zip(axs, months):
    one_day_grid_features = results[results['month'] == month]
...
plt.savefig('./images/pm2_5_china_overview_monthly.png', format='png', transparent=True, dpi=130, bbox_inches='tight')
# plt.show()
